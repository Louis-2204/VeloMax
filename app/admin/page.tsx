...
const page = async () => {
  ...
  if (
    profileConnected === null ||
    profileConnected.role === 'particulier' ||
    profileConnected.role === 'professionnel'
  ) {
    redirect('/'); // Redirect to home page if the user is not authorized
  }
  ...
  const tabs = [
    {
      ...
      path: `/admin/${profileConnected.id_boutique ? profileConnected.id_boutique : 'null'}/commandes-a-prendre-en-charge`,
    },
    {
      ...
      path: `/admin/${profileConnected.id_boutique ? profileConnected.id_boutique : 'null'}/commandes-prises-en-charge`,
    },
    {
      nom: 'Stock',
      icon: (
      ...
      path: `/admin/${profileConnected.id_boutique ? profileConnected.id_boutique : 'null'}/stock`,
    },
    {
      nom: 'Clients',
      icon: (
      ...
      ? [
        {
          ...
          path: `/admin/${profileConnected.id_boutique ? profileConnected.id_boutique : 'null'}/salaries`,
        },
      ]
      : []),
  ...
  return (
    <div className="flex flex-col w-full h-full max-w-8xl">
      ...
      <div className="flex flex-wrap justify-center mt-8 px-4 xl:px-0 gap-10 w-full">
        {tabs.map((tab, index) => (
          <Link href={tab.path} className="w-5/12 md:w-2/12 aspect-square max-w-[250px]">
            ...
            >
              <CardContent className="flex flex-col gap-2 justify-center items-center text-center p-4">
                {tab.icon}
                <p className="text-center w-full text-xs md:text-sm lg:text-xl">{tab.nom}</p>
              </CardContent>
            </Card>
          </Link>
        ))}
